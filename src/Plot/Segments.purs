      ...
      if depth < 5 then
        ...
        if depth >= 10 then
          ...
          segmentBasedOnDerivative
            ...
            x
            (checkFinite $ evaluator (rationalToNumber lower) <#> (_.value))
            (checkFinite $ evaluator (rationalToNumber upper) <#> (_.value))
            (checkFinite $ evaluator a1 <#> (_.derivative2))
            (checkFinite $ evaluator a2 <#> (_.derivative2))
            (checkFinite $ evaluator (rationalToNumber mid) <#> (_.derivative))
