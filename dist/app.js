...
(function($PS) {
  ...
  var FetchData = (function () {
      ...
      FetchData.value = new FetchData();
      return FetchData;
  })();
  var searchUser = function (q) {
      return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect_Aff.bindAff))(Control_Monad_Reader_Class.ask(Control_Monad_Reader_Trans.monadAskReaderT(Effect_Aff.monadAff)))(function (v) {
          return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Effect_Aff.bindAff))((function () {
              if (v.githubToken instanceof Data_Maybe.Nothing) {
                  return Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect_Aff.monadAff)(Affjax.get(Affjax_ResponseFormat.string)("https://api.github.com/users/" + q));
              };
              if (v.githubToken instanceof Data_Maybe.Just) {
                  return Control_Monad_Trans_Class.lift(Control_Monad_Reader_Trans.monadTransReaderT)(Effect_Aff.monadAff)(Affjax.get(Affjax_ResponseFormat.string)("https://api.github.com/users/" + (q + ("?access_token=" + v.githubToken.value0))));
              };
              throw new Error("Failed pattern match at Main (line 52, column 13 - line 56, column 100): " + [ v.githubToken.constructor.name ]);
          })())(function (result) {
              return Control_Applicative.pure(Control_Monad_Reader_Trans.applicativeReaderT(Effect_Aff.applicativeAff))(Data_Either.either(Data_Function["const"](""))(function (v1) {
                  return v1.body;
              })(result));
          });
      });
  ...
  var handleAction = function (v) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(Control_Monad_Reader_Trans.monadReaderT(Effect_Aff.monadAff))(searchUser("kRITZCREEK")))(function (userData) {
          return Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)({
              userData: new Data_Maybe.Just(userData)
          });
      });
  };
  var ui = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.h1_([ Halogen_HTML_Core.text("Fetch user data") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
              return new Data_Maybe.Just(FetchData.value);
          }) ])([ Halogen_HTML_Core.text("Fetch") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text(Data_Maybe.fromMaybe("No user data")(state.userData)) ]) ]);
      };
      var initialState = {
  ...
  var ui$prime = Halogen_Component.hoist(Halogen_HTML_Core.bifunctorHTML)(Effect_Aff.functorAff)(function (app) {
      return Control_Monad_Reader_Trans.runReaderT(app)({
          githubToken: Data_Maybe.Nothing.value
      });
  })(ui);
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Halogen_VDom_Driver.runUI(ui$prime)(Data_Unit.unit)(body);
  }));
